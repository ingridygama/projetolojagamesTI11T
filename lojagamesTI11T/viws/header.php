...
<a class="nav-link dropdown-toggle" href="#" id="navbarDropdown"role="button" data-bs-toggle="dropdown"aria-expanded="false">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <li><hr class="dropdown-divider"></li>
            <li><a class="dropdown-item" href="../viws/listatudoclientenome.php">Busca por nome</a></li>
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            <li><a class="dropdown-item" href="../viws/cadastrofuncionario.php">cadastro</a></li>
            <li><a class="dropdown-item" href="../viws/listadefuncionario.php">Visualizar</a></li>
            <li><hr class="dropdown-divider"></li>
            <li><a class="dropdown-item" href="../viws/listadefuncionarioCod.php">Busca por código</a></li>
          </ul>
        </li>
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
