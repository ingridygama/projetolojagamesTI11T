...
<div class="row mb-3">
    <label for="inputCodigo" class="col-sm-2 col-form-label">Dígite o nome do cliente:</label>
    <div class="col-sm-3">
      <input type="text" required name="codUsu" class="form-control" id="inputCodigo">
    </div>
    <div class="col-sm-3">
